...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, ResBlock_CBAM, Conv,SimConv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SimSPPF, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C2fAttn, PSA, SCDown,C2fCIB, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3):
            c1, c2 = ch[f], args[0]
